...
class Pg1(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="First Page", color="black", font_size="15dp",
                           bold=True, pos_hint={'center_x': .5, 'center_y': .27})
        self.add_widget(self.label)

        self.button = Button(text="go to Pg2", font_size="15dp", size_hint_x=.1, size_hint_y=.05,
                             bold=True, color="white", pos_hint={'center_x': .62, 'center_y': .27},
                             on_release=self.go_to_pg2)
...
class Pg2(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Second Page", color="black", font_size="15dp",
                           bold=True, pos_hint={'center_x': .56, 'center_y': .23})
        self.add_widget(self.label)
        self.button = Button(text="go to Pg3", font_size="15dp", size_hint_x=.1, size_hint_y=.05,
                             bold=True, color="white", pos_hint={'center_x': .62, 'center_y': .27},
                             on_release=self.go_to_pg3)
        self.add_widget(self.button)
...
class Pg3(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Third Page", color="black", font_size="15dp",
                           bold=True, pos_hint={'center_x': .5, 'center_y': .28})
        self.add_widget(self.label)

        self.pg4_button = Button(
            text="go to Pg4", font_size="15dp", size_hint_x=.1, size_hint_y=.05,
            bold=True, color="white", pos_hint={'center_x': .62, 'center_y': .27}, on_release=self.go_to_pg4)
        self.add_widget(self.pg4_button)
...
class Pg4(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(
            text="Fourth Page", color="black", font_size="15dp",
            bold=True, pos_hint={'center_x': .35, 'center_y': .29})
        self.add_widget(self.label)
        self.pg5_button = Button(
            text="go to Pg5", font_size="15dp", size_hint_x=.1, size_hint_y=.05,
            bold=True, color="white", pos_hint={'center_x': .62, 'center_y': .27}, on_release=self.go_to_pg5)
        self.add_widget(self.pg5_button)
...
class Pg5(Screen):
    def __init__(self, **kwargs):
        ...
        frame = Image(source="Logo-1.png", size_hint=(.4, .4), pos_hint={'center_x': .5, 'center_y': .35})
        self.add_widget(frame)
        ...
        self.label = Label(text="Fifth Page", color="black", font_size="15dp",
                           bold=True, pos_hint={'center_x': .85, 'center_y': .02})
        self.add_widget(self.label)
        self.pg6_button = Button(text="go to Pg6", font_size="15dp", size_hint_x=.1, size_hint_y=.05,
                                 bold=True, color="white", pos_hint={'center_x': .95, 'center_y': .02})
        self.pg6_button.bind(on_release=self.go_to_pg6)
        self.add_widget(self.pg6_button)
...
class Pg6(Screen):
    def __init__(self, **kwargs):
        ...
        frame = Image(source="Logo-1.png", size_hint=(.4, .4), pos_hint={'center_x': .5, 'center_y': .25})
        self.add_widget(frame)
        ...
        self.label = Label(text="Sixth Page", color="black", font_size="15dp", bold=True,
                           pos_hint={'center_x': .85, 'center_y': .02})
        self.add_widget(self.label)
        self.pg6_button = Button(text="go to Pg7", font_size="15dp", size_hint_x=.1, size_hint_y=.05, bold=True,
                                 color="white", pos_hint={'center_x': .95, 'center_y': .02})
        self.pg6_button.bind(on_release=self.go_to_pg7)
        self.add_widget(self.pg6_button)
    ...
    def on_pre_enter(self, *args):
        ...
        if not hasattr(app, 'matched_record'):
            ...
            return
        data = app.matched_record  # This is the same record from Pg4
    ...
    def on_enter(self):
        # Bind live auto-calculation when user types
    ...
    def update_record(self, instance):
        if hasattr(self, 'selected_row_data'):
            ...
            if closing_km < start_km:
                ...
                return
            # Auto-calculate Used Km and update the input field
            Used_km = closing_km - start_km
            self.Usedkm_input.text = str(Used_km)

            # Prepare updated record (keep old S.No for now)
            updated_record = (
                selected_row[0],  # Keep old S.No
                self.date_input.text,
                self.Model_input.text,
                self.Varient_input.text,
                self.RegNo_input.text,
            ...
            try:
                # Overwrite entire records.txt with updated list
...
class Pg7(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Seventh Page", color="black", font_size="15dp", bold=True,
                           pos_hint={'center_x': .35, 'center_y': .29})
        self.add_widget(self.label)
        self.pg5_button = Button(text="go to Pg8", font_size="15dp", size_hint_x=.1, size_hint_y=.05, bold=True,
                                 color="white", pos_hint={'center_x': .62, 'center_y': .27}, on_release=self.go_to_pg8)
        self.add_widget(self.pg5_button)
    ...
    def show_popup(self, title, message):
        ...
        layout.add_widget(label)
        layout.add_widget(close_button)
        popup = Popup(title=title, content=layout, size_hint=(0.3, 0.4), auto_dismiss=False)
        close_button.bind(on_press=popup.dismiss)
        popup.open()
...
class Pg8(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Eighth Page", color="black", font_size="15dp", bold=True,
                           pos_hint={'center_x': .85, 'center_y': .02})
        self.add_widget(self.label)
        self.pg6_button = Button(text="go to Pg9", font_size="15dp", size_hint_x=.1, size_hint_y=.05, bold=True,
                                 color="white", pos_hint={'center_x': .95, 'center_y': .02})
        self.pg6_button.bind(on_release=self.go_to_pg9)
        self.add_widget(self.pg6_button)
    ...
    def confirm_delete(self, instance):
        ...
        try:
            ...
            self.show_popup("Error", f"Failed to delete: {str(e)}")
    def export_to_excel(self, instance):
        try:
            ...
            if not os.path.exists(desktop):
                self.show_popup("Error", "Desktop path not found. Saving to project directory instead.")
...
class Pg9(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Nineth Page", color="black", font_size="15dp",
                           bold=True, pos_hint={'center_x': .85, 'center_y': .02})
        self.add_widget(self.label)

        self.pg6_button = Button(text="go to Pg10", font_size="15dp", size_hint_x=.1, size_hint_y=.05, bold=True,
                                 color="white", pos_hint={'center_x': .95, 'center_y': .02})
        self.pg6_button.bind(on_release=self.go_to_pg10)
        self.add_widget(self.pg6_button)
...
class Pg10(Screen):
    def __init__(self, **kwargs):
        ...
        self.label = Label(text="Tenth Page", color="black", font_size="15dp",
                           bold=True, pos_hint={'center_x': .85, 'center_y': .02})
        self.add_widget(self.label)
    ...
    def delete_password(self, instance):
        ...
        if not mobile:
            self.show_popup("Error", "Please enter a mobile number.")
            return
        ...
        if deleted_psm or deleted_reg:
            ...
            self.show_popup("Error", f"No record found for mobile {mobile}.")
        self.mobile_input.text = ""
    ...
    def show_popup(self, title, message):
        layout = BoxLayout(orientation='vertical', padding=10, spacing=10)
        label = Label(text=message, size_hint=(1, 0.7))
        close_button = Button(text="OK", size_hint=(2, 0.3))
        layout.add_widget(label)
        layout.add_widget(close_button)
        popup = Popup(title=title, content=layout, size_hint=(0.3, 0.3), auto_dismiss=False)
        close_button.bind(on_press=popup.dismiss)
